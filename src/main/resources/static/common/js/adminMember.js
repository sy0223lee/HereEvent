...
function checkSelectAll()  {
    // 전체 체크박스
    const checkboxes = document.querySelectorAll('input[name="memberNo"]');
    // 선택된 체크박스
    const checked = document.querySelectorAll('input[name="memberNo"]:checked');
    // select all 체크박스
...
function selectAll(selectAll)  {
    const checkboxes = document.getElementsByName('memberNo');
